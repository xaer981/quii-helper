...
class RbUdpLiveCommandsMixin:
    ...
    def _build_quii_play_inner(
        ...
        *,
        ...
        play_payload = normalize_live_play_payload(play_payload)
    ...
    def _live_command_lane_destinations(self) -> list[tuple[dict, int]]:
        return select_live_command_lane_destinations(
            self._connected_lane_destinations(),
            active_src_id=int(self.src_id),
        )
