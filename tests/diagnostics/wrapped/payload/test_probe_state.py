...
class WrappedPayloadProbeStateTests:
    ...
    def test_payload_embedded_probe_context_preserves_offsets_and_leading(
        ...
        assert b"prefix" + b"\x00\x00\x00\x01" + b"g" == (context["leading"])
        assert 6 == context["leading_start_code4_at"]
        assert 7 == context["leading_start_code3_at"]
        assert b"\x00\x00\x00\x01g" == context["leading_annexb_payload"]
    ...
    def test_leading_annexb_payload_prefers_four_byte_start_code(
        ...
        assert b"\x00\x00\x00\x01g\x00\x00\x01h" == (
